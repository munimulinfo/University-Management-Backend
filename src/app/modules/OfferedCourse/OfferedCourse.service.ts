...
const createOfferedCourseIntoDB = async (payload: TOfferedCourse) => {
  ...
  const isAcademicDepartmentExits =
    await AcademicDepertMentModel.findById(academicDepartment);
  ...
  const isFacultyExits = await FaculltyModel.findById(faculty);
  ...
  const isDepartmentBelongToFaculty = await AcademicDepertMentModel.findOne({
...
const updateOfferedCourseIntoDB = async (
  ...
  const isFacultyExists = await FaculltyModel.findById(faculty);
